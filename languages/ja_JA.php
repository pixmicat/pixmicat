...
$language['admin_list_header']			= '%1$s<th>ストップ</th><th>削除</th><th>投稿日</th><th>題名</th><th>投稿者</th><th>コメント</th><th>ホスト名</th><th>添付(Bytes)<br />MD5</th>';
...
$language['form_notice_noscript']		= '＊JavaScriptは無効にでもブラウジングと返答に影響しない。';
