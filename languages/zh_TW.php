...
$language['admin_list_header']			= '%1$s<th>停止</th><th>刪除</th><th>投稿日</th><th>標題</th><th>名稱</th><th>內文</th><th>主機位置名稱</th><th>附加圖檔 (Bytes)<br />MD5 檢查碼</th>';
...
$language['info_dsuseage_top']			= '記錄檔使用量';
$language['info_dsuseage_max']			= '最大筆數';
$language['info_dsuseage_usage']		= '使用率';
$language['info_dsuseage_count']		= '目前筆數';
$language['info_fileuseage_top']		= '附加圖檔總容量限制功能：';
$language['info_fileuseage_limit']		= '上限大小';
$language['info_fileuseage_count']		= '目前容量';
$language['info_fileuseage_unlimited']	= '無上限';
